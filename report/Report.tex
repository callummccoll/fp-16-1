...
\subsection{Emulation}
It is a little hard to show the end result of running an emulation, however figure \ref{fig:EnvironmentResult} shows a printout of the final state of a program once it has been emulated. Every instruction that can be parsed has been tested to make sure it works in relation to the original machine design that was created.

\begin{figure}[h]
    \centering
    \includegraphics[width=300px]{EmulationResult}
    \caption{Printout of an Emulation state.}
    \label{fig:EnvironmentResult}
\end{figure}
