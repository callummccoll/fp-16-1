...
The GUI implementation is separated into several modules, Figure \ref{fig:guimodules} shows how each of these modules relate to each other.
...
Figures~\ref{fig:screen_shot} and~ \ref{fig:screen_shot_running} show the final product when the assembly is editable and when it is running the emulation.
