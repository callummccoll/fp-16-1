...
Figures~\ref{fig:screen_shot} and~ \ref{fig:screen_shot_running} show the final product when the application is in edit mode and when it is running the emulation.
